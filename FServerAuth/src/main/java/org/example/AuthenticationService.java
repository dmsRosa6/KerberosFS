...
public class AuthenticationService {
    ...
    private static void handleAuthentication(SSLSocket requestSocket, Authentication authentication,
        ...
        try {
            ...
            RequestAuthenticationMessage request = (RequestAuthenticationMessage) Utils.deserialize(decryptedMessage);
            ...
            byte[] tgtBytes = Utils.serialize(tgt);
            ...
            byte[] responseBytes = Utils.serialize(new ResponseAuthenticationMessage(generatedkey, encryptedTGT));
